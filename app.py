...
width: 100%;
height: 100%;
background-color: rgba(0, 0, 0, 0.7);  /* Increased opacity for less transparency */
}}

input {{
    background-color: rgba(255, 255, 255, 0.9);  /* Adjusted background color for less transparency */
    color: black;  /* Ensure text color is visible */
}}

.title, .write {{
    background-color: rgba(255, 255, 255, 0.9); /* Increased alpha value for title and write sections */
}}
</style>
"""
